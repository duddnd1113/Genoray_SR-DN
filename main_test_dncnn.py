...
def main():
    ...
    parser.add_argument('--testset_name', type=str, default='FINAL_TEST', help='test set, bsd68 | set12')
    ...
    # GT 이미지 추가
    parser.add_argument('--gt_name', type = str, default = 'genoray_GT', help = 'for GT Folder')
    ...
    H_path = os.path.join(args.testsets, args.gt_name)
